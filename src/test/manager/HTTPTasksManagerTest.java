...
class HTTPTasksManagerTest {
    ...
    void shouldCreateNewTask() throws IOException, InterruptedException {
        ...
        testTask1.setStartTime(LocalDateTime.parse("27.07.2022 18:00", dateTimeFormatter));
        testTask1.setDuration(Duration.ofDays(60));
    ...
    void shouldCreateNewEpicAndSubTask() throws IOException, InterruptedException {
        Epic testEpic1 = new Epic(1, "Тест", "Создать Epic");
    ...
    void shouldDeleteEpicAndSubTaskById() throws IOException, InterruptedException {
        Epic testEpic1 = new Epic(2, "Тест", "Создать Epic");
        testEpic1.setStatus(Status.NEW);
    ...
    void shouldUpdateSubTaskById() throws IOException, InterruptedException {
        ...
        testSubTask1.setStartTime(LocalDateTime.parse("27.07.2022 14:00", dateTimeFormatter));
        testSubTask1.setDuration(Duration.ofDays(60));
    ...
    @DisplayName("Проверяет, смогут ли восстановиться из KVServer данные после завершения " +
